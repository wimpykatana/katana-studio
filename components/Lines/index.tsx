...
const Lines = () => {
  return (
    <div className="fixed left-0 top-0 -z-20 flex h-full w-full items-center justify-around">
      ...
      <span className="animate-line4 flex h-full w-[1px] bg-stroke dark:bg-strokedark"></span>
      <span className="animate-line5 flex h-full w-[1px] bg-stroke dark:bg-strokedark"></span>
    </div>
  );
};
